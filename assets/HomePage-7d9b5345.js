...
`,ie=e=>e.waters.dailyNorm,tt=e=>e.waters.reps,be=e=>e.filter,nt=e=>e.waters.month,rt=e=>e.waters;_e([ie,be],(e,n)=>e.filter(t=>t.name.toLowerCase().includes(n.toLowerCase())));const E=()=>{const e=re(),n=_(ie),t=_(tt),r=_(be),i=w.useCallback(u=>e(Ye(u)),[e]),c=w.useCallback(u=>e(ze(u)),[e]),d=w.useCallback(u=>e(Ne(u)),[e]),p=w.useCallback(u=>e(Ee(u)),[e]),m=w.useCallback(u=>e(Ae(u)),[e]);return{dailyNorm:n,reps:t,filter:r,addDailyNorma:c,deleteReps:d,patchWater:p,addOneDrink:m,createWater:i}},ot=s.h2`
  font-size: 26px;
  line-height: 32px;
  margin-bottom: 16px;
`,at=s.div`
...
`;function mt({toggleModal:e}){const{addDailyNorma:n}=E(),t=u=>{const{gender:x,weight:f,activityHours:$}=u;if(x&&f&&$){if(x==="man")return parseFloat(f)*.04+parseFloat($)*.6;if(x==="woman")return parseFloat(f)*.03+parseFloat($)*.4}return null},r={gender:"man",weight:"",activityHours:"",dailyNorma:""},i=new Date,c=String(i.getDate()).padStart(2,"0"),d=String(i.getMonth()+1).padStart(2,"0"),p=String(i.getFullYear()),m=`${c}.${d}.${p}`;return o.jsxs(xt,{children:[o.jsx(ot,{children:"My daily norma"}),o.jsx(oe,{initialValues:r,onSubmit:u=>{const f={daily_limit:u.dailyNorma*1e3,date:m};console.log("Form dailyNorma:",f),n(f),e()},children:({errors:u,touched:x,values:f,setFieldValue:$})=>o.jsxs(He,{children:[o.jsxs(at,{children:[o.jsxs(se,{children:["For girl:"," ",o.jsx(ce,{children:"V=(M*0,03) + (T*0,4)"})]}),o.jsxs(se,{children:["For man:"," ",o.jsx(ce,{children:"V=(M*0,04) + (T*0,6)"})]})]}),o.jsx(it,{children:o.jsxs(st,{children:[o.jsx(ct,{children:"* "}),"V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})}),o.jsxs(dt,{children:[o.jsx(lt,{children:"Calculate your rate:"}),o.jsxs(ut,{children:[o.jsxs("label",{children:[o.jsx(H,{type:"radio",name:"gender",value:"man",onChange:()=>$("gender","man")}),"For man"]}),o.jsxs("label",{children:[o.jsx(H,{type:"radio",name:"gender",value:"woman",onChange:()=>$("gender","woman")}),"For woman"]})]}),u.gender&&x.gender&&o.jsx("div",{children:x.gender})]}),o.jsx(de,{children:o.jsxs(Z,{children:[o.jsx(ee,{children:"Your weight in kilograms:"}),o.jsx(te,{type:"number",name:"weight",placeholder:"0"}),u.weight&&x.weight&&o.jsx("div",{children:u.weight})]})}),o.jsxs(de,{children:[o.jsxs(ee,{children:[" ","The time of active participation in sports or other activities with a high physical. load in hours:"]}),o.jsxs(Z,{children:[o.jsx(te,{type:"number",name:"activityHours",placeholder:"0"}),u.activityHours&&x.activityHours&&o.jsx("div",{children:u.activityHours})]})]}),o.jsxs(ht,{children:["Your recommended water intake per day is:",o.jsxs("span",{children:[t(f)?parseFloat(t(f)).toFixed(2):0,"L"]})]}),o.jsx(ee,{children:"Write down how much water you will drink:"}),o.jsx(Z,{children:o.jsx(te,{type:"number",name:"dailyNorma",placeholder:"0"})}),o.jsx(pt,{type:"submit",children:"Save"})]})})]})}const gt=()=>{const[e,n]=w.useState(!1),t=()=>{n(!e)},i=(_(ie)/1e3).toFixed(1)+" L";return o.jsxs(Ve,{children:[o.jsxs(Ke,{children:[o.jsx(Ue,{children:"My daily norma"}),o.jsxs(Ze,{children:[o.jsx("p",{children:i}),o.jsx(et,{type:"button",onClick:t,children:"Edit"})]})]}),o.jsx(Je,{}),e&&o.jsx(ae,{onClose:t,children:o.jsx(mt,{toggleModal:t})})]})},ft=s.div`
  display: flex;
  flex-direction: column;
  gap: 20px;
  justify-content: center;
...
`;const qt=({toggleModal:e})=>{const[n,t]=w.useState(""),[r,i]=w.useState([]),{addOneDrink:c}=E(),[d,p]=w.useState(0);w.useEffect(()=>{const l=new Date,h=l.getHours(),y=l.getMinutes(),S=[];for(let O=h;O<24;O++)for(let W=0;W<60;W+=5){if(O===h&&W<y)continue;const J=String(O).padStart(2,"0"),U=String(W).padStart(2,"0"),K=`${J}:${U}`;S.push(K)}const Q=String(h).padStart(2,"0"),G=String(y).padStart(2,"0"),V=`${Q}:${G}`;t(V),i(S)},[]);const m=new Date,u=String(m.getDate()).padStart(2,"0"),x=String(m.getMonth()+1).padStart(2,"0"),f=String(m.getFullYear()),$=`${u}.${x}.${f}`,v=l=>{let h="";return l>5e3&&(h="The value cannot exceed 5000ml"),h},g=l=>{l.preventDefault();const h={time:n,amount:d,date:$};console.log(h),c(h),p(0),t(""),e()},j=()=>{p(l=>Math.max(l-50,0))},k=()=>{const l=d+50,h=5e3;p(l<=h?l:h)};return o.jsx(oe,{initialValues:{amount:0,time:n},onSubmit:g,children:()=>o.jsxs(we,{children:[o.jsxs(ye,{children:[o.jsx(ke,{children:"Edit the entered amount of water"}),o.jsxs(Ht,{children:[o.jsx(Lt,{children:o.jsx("use",{href:`${M}#icon-glass`})}),o.jsxs("h4",{children:[d," ml"]}),o.jsxs("p",{children:[n," AM"]})]}),o.jsx($e,{children:"Choose a value:"}),o.jsx(L,{children:"Amount of water:"}),o.jsxs("div",{children:[o.jsx(q,{type:"button",onClick:j,children:o.jsx(R,{children:o.jsx("use",{href:`${M}#icon-minus`})})}),o.jsx(ve,{children:o.jsxs(je,{children:[d," ml"]})}),o.jsx(q,{type:"button",onClick:k,children:o.jsx(R,{children:o.jsx("use",{href:`${M}#icon-plus`})})})]})]}),o.jsxs(Me,{children:[o.jsx(L,{children:"Recording time:"}),o.jsxs(De,{name:"time",style:{width:"100%"},onChange:l=>t(l.target.value),children:[o.jsx("option",{value:n,children:n},"current-time"),r.map(l=>o.jsx("option",{value:l,children:l},l))]})]}),o.jsxs("div",{children:[o.jsx("h3",{children:"Enter the value of the water used:"}),o.jsx(Se,{type:"number",name:"amount",validate:v,max:5e3,value:d}),o.jsx(fe,{name:"amount",component:"div"})]}),o.jsxs(Oe,{children:[o.jsxs("span",{children:[d,"ml"]}),o.jsxs(We,{type:"submit",onClick:g,children:["Save"," "]})]})]})})},Rt=s.div`
  display: flex;
  flex-direction: column;
  margin: 8px 12px;
  row-gap: 24px;
