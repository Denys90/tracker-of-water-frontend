...
`,A=({onClose:e,children:n})=>{const t=document.getElementById("modal-root"),r=g.useRef(),i=d=>{d.target===r.current&&e(),document.body.style.overflow="",document.body.style.position="",d.stopPropagation()},c=d=>{d.key==="Escape"&&(document.body.style.overflow="",document.body.style.position="",e())};return g.useEffect(()=>{const d=l=>c(l);return document.addEventListener("keydown",d),document.body.style.overflow="hidden",()=>{document.removeEventListener("keydown",d)}},[]),he.createPortal(o.jsx(Be,{onClick:i,ref:r,children:o.jsx(Ce,{children:o.jsxs(Fe,{children:[o.jsx(Ye,{onClick:e,children:o.jsx("svg",{children:o.jsx("use",{href:`${j}#closeModal`})})}),n]})})}),t)},ae=e=>e.waters.dailyNorm,ie=e=>e.waters.reps,se=e=>e.filter,_e=e=>e.waters;pe([ae,se],(e,n)=>e.filter(t=>t.name.toLowerCase().includes(n.toLowerCase())));const Ee=()=>{const e=H(),n=O(ae),t=O(ie),r=O(se),i=g.useCallback(u=>e(oe(u)),[e]),c=g.useCallback(u=>e(me(u)),[e]),d=g.useCallback(u=>e(xe(u)),[e]),l=g.useCallback(u=>e(fe(u)),[e]);return{dailyNorm:n,reps:t,filter:r,getWaters:i,addDailyNorma:c,deleteReps:d,patchWater:l}},ze=s.h2`
  font-size: 26px;
  line-height: 32px;
  margin-bottom: 24px;
`,Ne=s.div`
...
`;function Ve(){const{addDailyNorma:e}=Ee(),n=t=>{const{gender:r,weight:i,activityHours:c}=t;if(r&&i&&c){if(r==="man")return parseFloat(i)*.04+parseFloat(c)*.6;if(r==="woman")return parseFloat(i)*.03+parseFloat(c)*.4}return null};return o.jsxs(Ge,{children:[o.jsx(ze,{children:"My daily norma"}),o.jsx(be,{initialValues:{gender:"man",weight:"",activityHours:""},onSubmit:(t,{setSubmitting:r})=>{const i=n(t);e({waterIntake:i}),console.log("Form data:",{...t,waterIntake:i}),r(!1)},children:({isSubmitting:t,errors:r,touched:i,values:c,setFieldValue:d})=>o.jsxs(we,{children:[o.jsxs(Ne,{children:[o.jsxs(I,{children:["For girl:"," ",o.jsx(X,{children:"V=(M*0,03) + (T*0,4)"})]}),o.jsxs(I,{children:["For man:"," ",o.jsx(X,{children:"V=(M*0,04) + (T*0,6)"})]})]}),o.jsx(Le,{children:o.jsxs(He,{children:[o.jsx(Ae,{children:"* "}),"V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})}),o.jsxs(qe,{children:[o.jsx(Re,{children:"Calculate your rate:"}),o.jsxs(Ie,{children:[o.jsxs("label",{children:[o.jsx(L,{type:"radio",name:"gender",value:"man",onChange:()=>d("gender","man")}),"For man"]}),o.jsxs("label",{children:[o.jsx(L,{type:"radio",name:"gender",value:"woman",onChange:()=>d("gender","woman")}),"For woman"]})]}),r.gender&&i.gender&&o.jsx("div",{children:r.gender})]}),o.jsx(Q,{children:o.jsxs(_,{children:[o.jsx(E,{children:"Your weight in kilograms:"}),o.jsx(z,{type:"number",name:"weight",placeholder:"0"}),r.weight&&i.weight&&o.jsx("div",{children:r.weight})]})}),o.jsxs(Q,{children:[o.jsxs(E,{children:[" ","The time of active participation in sports or other activities with a high physical. load in hours:"]}),o.jsxs(_,{children:[o.jsx(z,{type:"number",name:"activityHours",placeholder:"0"}),r.activityHours&&i.activityHours&&o.jsx("div",{children:r.activityHours})]})]}),o.jsxs(Xe,{children:["Your recommended water intake per day is:",o.jsxs("span",{children:[n(c)?parseFloat(n(c)).toFixed(2):0,"L"]})]}),o.jsx(E,{children:"Write down how much water you will drink:"}),o.jsx(_,{children:o.jsx(z,{type:"number",name:"Iwilldrunk",placeholder:"0"})}),o.jsx(Qe,{type:"submit",disabled:t,children:"Save"})]})})]})}const Je=()=>{const[e,n]=g.useState(!1),t=()=>{n(!e)},i=(2e3/1e3).toFixed(1)+" L";return o.jsxs(De,{children:[o.jsxs(Oe,{children:[o.jsx(We,{children:"My daily norma"}),o.jsxs(Se,{children:[o.jsx("p",{children:i}),o.jsx(Te,{type:"button",onClick:t,children:"Edit"})]})]}),o.jsx(Pe,{}),e&&o.jsx(A,{onClose:t,children:o.jsx(Ve,{})})]})},Ue=s.div`
  display: flex;
  flex-direction: column;
  gap: 20px;
  justify-content: center;
...
`,vt=({onClose:e})=>{const[t,r]=g.useState(0),[i,c]=g.useState(new Date().toISOString().slice(0,16)),d=H(),{isLoading:l}=O(lt),u=p=>{let m=p.target.value;m.startsWith("0")&&m.length>1&&(m=parseFloat(m.substring(1))),r(m.toString())},x=()=>{d(ge({waterVolume:t,date:i})).then(m=>{m.error||(e(),r(0))})},f=()=>{r(p=>Math.max(p-50,0))},w=()=>{const p=t+50,m=5e3;r(p<=m?p:m)};return o.jsx(o.Fragment,{children:o.jsxs(ut,{onClose:e,children:[o.jsxs(ht,{children:[o.jsx(pt,{children:"Add Water"}),o.jsx(mt,{children:"Choose a value:"}),o.jsx(G,{children:"Amount of water:"}),o.jsxs("div",{children:[o.jsx(V,{onClick:f,children:o.jsx(J,{children:o.jsx("use",{href:`${j}#icon-minus`})})}),o.jsx(ft,{children:o.jsxs(xt,{children:[t," ml"]})}),o.jsx(V,{onClick:w,children:o.jsx(J,{children:o.jsx("use",{href:`${j}#icon-plus`})})})]})]}),o.jsxs(gt,{children:[o.jsx(G,{children:"Recording time:"}),o.jsx(bt,{value:i,onChange:p=>c(p.target.value),step:"300"})]}),o.jsxs("div",{children:[o.jsx("h3",{children:"Enter the value of the water used:"}),o.jsx(wt,{type:"number",value:t,onChange:u,onBlur:()=>r(p=>p||0||0),max:5e3})]}),o.jsxs(yt,{children:[o.jsxs("span",{children:[t,"ml"]}),o.jsxs(kt,{onClick:x,children:["Save ",l&&o.jsx(dt,{})]})]})]})})},jt=()=>{const[e,n]=g.useState(!1),t=O(_e),r=()=>{n(!e)},i=t.percent;return o.jsxs(Ue,{children:[o.jsxs(Ze,{children:[o.jsx(Ke,{children:"Today"}),o.jsxs(et,{children:[o.jsx(tt,{children:o.jsx(nt,{style:{width:`${Math.min(i,100)}%`}})}),o.jsxs(rt,{children:[o.jsx(ot,{children:"0%"}),i<100&&i>0&&o.jsxs(it,{left:`${i}%`,children:[i,"%"]}),o.jsx(at,{children:"100%"})]})]})]}),o.jsxs(st,{onClick:r,children:[o.jsx("svg",{children:o.jsx("use",{href:`${j}#icon-outline`})}),"Add water"]}),e&&o.jsx(A,{onClose:r,children:o.jsx(vt,{})})]})},$t=s.div`
  display: flex;
  flex-direction: column;
  margin-bottom: 24px;
`,Mt=s.div`
...
`,Ft=()=>{const e=Date.now(),t=new Date(e).toLocaleDateString(),[r,i]=g.useState(!1),c=H(),d=O(ie);g.useEffect(()=>{c(oe({date:t}))},[c,t]);const l=()=>{i(!r)};return o.jsxs(o.Fragment,{children:[o.jsxs($t,{children:[o.jsx(Pt,{children:"Today"}),o.jsx(Mt,{children:d.map(u=>o.jsxs(Dt,{children:[o.jsxs(Wt,{children:[o.jsx(Ot,{children:o.jsx("use",{href:`${j}#icon-glass`})}),o.jsxs("h4",{children:[u.amount," ml"]}),o.jsxs("p",{children:[u.time,o.jsx("span",{children:" AM"})]})]}),o.jsxs(St,{children:[o.jsx(Tt,{children:o.jsx("use",{href:`${j}#icon-note`})}),o.jsx(Bt,{children:o.jsx("use",{href:`${j}#icon-trash`})})]})]},u._id))}),o.jsxs(Ct,{onClick:l,children:[o.jsx("svg",{children:o.jsx("use",{href:`${j}#icon-increment`})}),"Add water"]})]}),r&&o.jsx(A,{onClose:l,children:o.jsx("h2",{children:"Drink list"})})]})};const Yt=s.div`
  display: flex;
  flex-direction: column;
  h3 {
    font-size: 24px;
