...
`,Ft=()=>{const e=Date.now(),t=new Date(e).toLocaleDateString(),[r,i]=g.useState(!1),c=H(),d=T(ie);g.useEffect(()=>{c(oe({date:t}))},[c,t]);const l=()=>{i(!r)};return o.jsxs(o.Fragment,{children:[o.jsxs($t,{children:[o.jsx(Pt,{children:"Today"}),o.jsx(Mt,{children:d.map(u=>o.jsxs(Dt,{children:[o.jsxs(Wt,{children:[o.jsx(Ot,{children:o.jsx("use",{href:`${j}#icon-glass`})}),o.jsxs("h4",{children:[u.amount," ml"]}),o.jsxs("p",{children:[u.time,o.jsx("span",{children:" AM"})]})]}),o.jsxs(St,{children:[o.jsx(Tt,{children:o.jsx("use",{href:`${j}#icon-note`})}),o.jsx(Bt,{children:o.jsx("use",{href:`${j}#icon-trash`})})]})]},u._id))}),o.jsxs(Ct,{onClick:l,children:[o.jsx("svg",{children:o.jsx("use",{href:`${j}#icon-increment`})}),"Add water"]})]}),r&&o.jsx(q,{onClose:l,children:o.jsx("h2",{children:"Drink list"})})]})};const Yt=s.div`
  display: flex;
  flex-direction: column;
  h3 {
    font-size: 24px;
