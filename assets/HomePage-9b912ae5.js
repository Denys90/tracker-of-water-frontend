import{n as s,t as a,e as ze,f as ge,g as z,r as k,h as Ee,i as _e,k as Ne,p as He,l as Ae,F as R,j as r,b as re,c as Le,M as oe,s as S,E as fe,m as Re}from"./index-69712bd7.js";import{h as qe,i as Ie,a as Xe,b as Qe,c as Ve,d as Ge,e as Je}from"./bottle_home_deskx2-274c1be2.js";const Ue="/tofw__frontend/assets/bottle_home_mobile@1x-0d6054eb.png",Ke="/tofw__frontend/assets/bottle_home_mobile@2x-52eb5066.png",Ze="/tofw__frontend/assets/bottle_home_tablet@1x-c4bedac4.png",et="/tofw__frontend/assets/bottle_home_tablet@2x-867eb443.png",tt="/tofw__frontend/assets/bottle_home_desk-f67b46be.png",nt=s.div`
  display: flex;
...
`,ae=e=>e.waters.dailyNorm,ct=e=>e.waters.reps,be=e=>e.filter,dt=e=>e.waters.month,lt=e=>e.waters;ze([ae,be],(e,n)=>e.filter(t=>t.name.toLowerCase().includes(n.toLowerCase())));const A=()=>{const e=ge(),n=z(ae),t=z(ct),o=z(be),i=k.useCallback(d=>e(Ee(d)),[e]),c=k.useCallback(d=>e(_e(d)),[e]),l=k.useCallback(d=>e(Ne(d)),[e]),p=k.useCallback(d=>e(He(d)),[e]),h=k.useCallback(d=>e(Ae(d)),[e]);return{dailyNorm:n,reps:t,filter:o,addDailyNorma:c,deleteReps:l,patchWater:p,addOneDrink:h,createWater:i}},ut=s.h2`
  font-size: 26px;
  line-height: 32px;
  margin-bottom: 16px;
`,ht=s.div`
