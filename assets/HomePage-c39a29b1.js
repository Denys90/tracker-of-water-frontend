...
`,on=({onClose:e,waterId:n,initialAmount:t,initialTime:r})=>{const[i,c]=y.useState(t||0),[d,h]=y.useState(r||""),g=G(),{isLoading:l}=C(qt),[x,m]=y.useState(""),k=f=>{let u=f.target.value;if(u>5e3){m("The value cannot exceed 5000ml");return}else m("");u.startsWith("0")&&u.length>1&&(u=parseFloat(u.substring(1))),c(u.toString())},j=()=>{g(xe(n,{waterVolume:i,date:d})).then(u=>{u.error||e()})},M=()=>{c(f=>Math.max(f-50,0))},D=()=>{const f=i+50,u=5e3;c(f<=u?f:u)};return o.jsx(o.Fragment,{children:o.jsxs(Rt,{onClose:e,children:[o.jsx(Xt,{children:"Edit the entered amount of water"}),o.jsxs(It,{children:[o.jsxs(Qt,{children:[o.jsx(Gt,{children:o.jsx("use",{href:`${$}#icon-glass`})}),o.jsxs("h4",{children:[i," ml"]}),o.jsx("p",{children:d})]}),o.jsxs(Vt,{children:[o.jsx(re,{children:"Correct entered date:"}),o.jsx(oe,{children:"Amount of water:"}),o.jsxs(Jt,{children:[o.jsx(ae,{onClick:M,children:o.jsx(ie,{children:o.jsx("use",{href:`${$}#icon-minus`})})}),o.jsx(Ut,{children:o.jsxs(Kt,{children:[i," ml"]})}),o.jsx(ae,{onClick:D,children:o.jsx(ie,{children:o.jsx("use",{href:`${$}#icon-plus`})})})]})]}),o.jsxs(Zt,{children:[o.jsx(oe,{children:"Recording time:"}),o.jsx(fe,{value:d,onChange:f=>h(f.target.value),style:{width:"100%"},children:o.jsx("option",{value:d,children:d},"current-time")})]}),o.jsxs(en,{children:[o.jsx(re,{children:"Enter the value of the water used:"}),o.jsx(rn,{type:"number",value:i,onChange:k,onBlur:()=>c(f=>f||t||0),max:5e3}),x&&o.jsx(Tt,{children:x})]})]}),o.jsxs(tn,{children:[o.jsxs("span",{children:[i,"ml"]}),o.jsxs(nn,{onClick:j,children:["Save ",l&&o.jsx(ze,{})]})]})]})})},an=s.div`
  display: flex;
  flex-direction: column;
  margin: 8px 12px;
  row-gap: 24px;
