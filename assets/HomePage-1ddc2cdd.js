...
`;const qt=({toggleModal:e})=>{const[n,t]=y.useState(""),[r,i]=y.useState([]),{addOneDrink:c}=N(),[d,p]=y.useState(0);y.useEffect(()=>{const l=new Date,h=l.getHours(),k=l.getMinutes(),S=[];for(let O=h;O<24;O++)for(let P=0;P<60;P+=5){if(O===h&&P<k)continue;const J=String(O).padStart(2,"0"),U=String(P).padStart(2,"0"),K=`${J}:${U}`;S.push(K)}const Q=String(h).padStart(2,"0"),G=String(k).padStart(2,"0"),V=`${Q}:${G}`;t(V),i(S)},[]);const g=new Date,u=String(g.getDate()).padStart(2,"0"),m=String(g.getMonth()+1).padStart(2,"0"),f=String(g.getFullYear()),$=`${u}.${m}.${f}`,v=l=>{let h="";return l>5e3&&(h="The value cannot exceed 5000ml"),h},D=l=>{l.preventDefault();const h={time:n,amount:d,date:$};console.log(h),c(h),p(0),t(""),e()},x=()=>{p(l=>Math.max(l-50,0))},w=()=>{const l=d+50,h=5e3;p(l<=h?l:h)};return o.jsx(oe,{initialValues:{amount:0,time:n},onSubmit:D,children:()=>o.jsxs(we,{children:[o.jsxs(ye,{children:[o.jsx(ke,{children:"Edit the entered amount of water"}),o.jsxs(Ht,{children:[o.jsx(Lt,{children:o.jsx("use",{href:`${j}#icon-glass`})}),o.jsxs("h4",{children:[d," ml"]}),o.jsxs("p",{children:[n," AM"]})]}),o.jsx($e,{children:"Choose a value:"}),o.jsx(L,{children:"Amount of water:"}),o.jsxs("div",{children:[o.jsx(q,{type:"button",onClick:x,children:o.jsx(R,{children:o.jsx("use",{href:`${j}#icon-minus`})})}),o.jsx(je,{children:o.jsxs(ve,{children:[d," ml"]})}),o.jsx(q,{type:"button",onClick:w,children:o.jsx(R,{children:o.jsx("use",{href:`${j}#icon-plus`})})})]})]}),o.jsxs(Me,{children:[o.jsx(L,{children:"Recording time:"}),o.jsxs(De,{name:"time",style:{width:"100%"},onChange:l=>t(l.target.value),children:[o.jsx("option",{value:n,children:n},"current-time"),r.map(l=>o.jsx("option",{value:l,children:l},l))]})]}),o.jsxs("div",{children:[o.jsx("h3",{children:"Enter the value of the water used:"}),o.jsx(Se,{type:"number",name:"amount",validate:v,max:5e3,value:d}),o.jsx(fe,{name:"amount",component:"div"})]}),o.jsxs(Oe,{children:[o.jsxs("span",{children:[d,"ml"]}),o.jsxs(Pe,{type:"submit",onClick:D,children:["Save"," "]})]})]})})},Rt=s.div`
  display: flex;
  flex-direction: column;
  margin: 8px 12px;
  row-gap: 24px;
