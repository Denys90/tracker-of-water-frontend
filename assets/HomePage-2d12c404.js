...
`,tn=({id:e,date:n,onClose:t})=>{const{deleteReps:o,createWater:a}=H(),c=()=>{o({id:e,date:n}),a(n),t()};return r.jsx(r.Fragment,{children:r.jsxs(Jt,{children:[r.jsxs(Ut,{children:[r.jsx("h2",{children:"Delete entry"}),r.jsx("p",{children:"Are you sure you want to delete the entry?"})]}),r.jsxs(Kt,{children:[r.jsx(Zt,{type:"button",onClick:t,children:"Cancel"}),r.jsx(en,{type:"button",onClick:c,children:"Delete"})]})]})})},nn=()=>{const[e,n]=y.useState(!1),[t,o]=y.useState(null),{createWater:a,reps:c}=H(),x=Date.now(),m=new Date(x).toLocaleDateString();y.useEffect(()=>{a({date:m})},[m,a]);const d=()=>{n(!e)},g=f=>{o(f),n(!0)};return r.jsxs(r.Fragment,{children:[r.jsxs(zt,{children:[r.jsx(Ht,{children:"Today"}),r.jsx(Et,{children:c.map(f=>{const[k,$]=f.time.split(":").map(Number),D=k>=12?k-12:k,p=k>=12?"PM":"AM",w=D===0?12:D;return r.jsxs(Nt,{children:[r.jsxs(At,{children:[r.jsx(Lt,{children:r.jsx("use",{href:`${M}#icon-glass`})}),r.jsxs("h4",{children:[f.amount," ml"]}),r.jsxs("p",{children:[w,":",$<10?"0"+$:$," ",p]})]}),r.jsxs(Rt,{children:[r.jsx(qt,{onClick:()=>g(r.jsx(Gt,{onClose:d})),children:r.jsx("use",{href:`${M}#icon-note`})}),r.jsx(It,{onClick:()=>g(r.jsx(tn,{id:f._id,date:{date:m},onClose:d})),children:r.jsx("use",{href:`${M}#icon-trash`})})]})]},Yt())})}),r.jsxs(Xt,{onClick:()=>g(r.jsx(We,{onClose:d})),children:[r.jsx("svg",{children:r.jsx("use",{href:`${M}#icon-increment`})}),"Add water"]})]}),e&&r.jsx(oe,{onClose:d,children:t})]})};const rn=s.div`
  display: flex;
  flex-direction: column;
