...
`,ae=e=>e.waters.dailyNorm,ct=e=>e.waters.reps,be=e=>e.filter,dt=e=>e.waters.month,lt=e=>e.waters;_e([ae,be],(e,n)=>e.filter(t=>t.name.toLowerCase().includes(n.toLowerCase())));const A=()=>{const e=ge(),n=_(ae),t=_(ct),o=_(be),i=k.useCallback(d=>e(ze(d)),[e]),c=k.useCallback(d=>e(Ee(d)),[e]),l=k.useCallback(d=>e(Ne(d)),[e]),p=k.useCallback(d=>e(He(d)),[e]),h=k.useCallback(d=>e(Ae(d)),[e]);return{dailyNorm:n,reps:t,filter:o,addDailyNorma:c,deleteReps:l,patchWater:p,addOneDrink:h,createWater:i}},ut=s.h2`
  font-size: 26px;
  line-height: 32px;
  margin-bottom: 16px;
`,ht=s.div`
...
`,nn=({id:e,date:n,onClose:t})=>{const{deleteReps:o,createWater:i}=A(),c=()=>{o({id:e,date:n}),i(n),t()};return r.jsx(r.Fragment,{children:r.jsxs(Ut,{children:[r.jsxs(Kt,{children:[r.jsx("h2",{children:"Delete entry"}),r.jsx("p",{children:"Are you sure you want to delete the entry?"})]}),r.jsxs(Zt,{children:[r.jsx(en,{type:"button",onClick:t,children:"Cancel"}),r.jsx(tn,{type:"button",onClick:c,children:"Delete"})]})]})})},rn=()=>{const[e,n]=k.useState(!1),[t,o]=k.useState(null),{createWater:i,reps:c}=A(),l=Date.now(),h=new Date(l).toLocaleDateString();k.useEffect(()=>{i({date:h})},[h,i]);const d=(y,j)=>{o(y),n(!j),n(!0)},m=()=>{n(!1)},w=()=>{n(!e)};return r.jsxs(r.Fragment,{children:[r.jsxs(Et,{children:[r.jsx(At,{children:"Today"}),r.jsx(Nt,{children:c.map(y=>{const[j,D]=y.time.split(":").map(Number),u=j>=12?j-12:j,b=j>=12?"PM":"AM",M=u===0?12:u;return r.jsxs(Ht,{children:[r.jsxs(Lt,{children:[r.jsx(Rt,{children:r.jsx("use",{href:`${S}#icon-glass`})}),r.jsxs("h4",{children:[y.amount," ml"]}),r.jsxs("p",{children:[M,":",D<10?"0"+D:D," ",b]})]}),r.jsxs(qt,{children:[r.jsx(It,{onClick:()=>d(r.jsx(Jt,{id:y._id,onClose:m})),children:r.jsx("use",{href:`${S}#icon-note`})}),r.jsx(Xt,{onClick:()=>d(r.jsx(nn,{id:y._id,date:{date:h},onClose:m})),children:r.jsx("use",{href:`${S}#icon-trash`})})]})]},zt())})}),r.jsxs(Qt,{onClick:()=>d(r.jsx(We,{onClose:m})),children:[r.jsx("svg",{children:r.jsx("use",{href:`${S}#icon-increment`})}),"Add water"]})]}),e&&r.jsx(oe,{onClose:w,children:t})]})};const on=s.div`
  display: flex;
  flex-direction: column;
