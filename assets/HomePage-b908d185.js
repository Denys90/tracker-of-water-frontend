import{n as h,t as l,r as S,R as jt,j as s,c as Ot,u as it,a as se,g as St,d as Ft,e as _t,p as Tt,f as Dt,s as b,h as Et}from"./index-0095f7f9.js";import{F as te,a as Mt,b as Ct}from"./formik.esm-087a44e9.js";const Pt="/runners_of_code__frontend/assets/bottle_home_mobile@1x-0d6054eb.png",At="/runners_of_code__frontend/assets/bottle_home_mobile@2x-52eb5066.png",Wt="/runners_of_code__frontend/assets/bottle_home_tablet@1x-c4bedac4.png",Nt="/runners_of_code__frontend/assets/bottle_home_tablet@2x-867eb443.png",zt="/runners_of_code__frontend/assets/bottle_home_desk-f67b46be.png",Bt="/runners_of_code__frontend/assets/bottle_home_deskx2-acd9b153.png",Yt=h.div`
  display: flex;
...
`;function sr(){const{addDailyNorma:n}=Zt(),e=t=>{const{gender:r,weight:i,activityHours:a}=t;if(r&&i&&a){if(r==="man")return parseFloat(i)*.04+parseFloat(a)*.6;if(r==="woman")return parseFloat(i)*.03+parseFloat(a)*.4}return null};return s.jsxs(ir,{children:[s.jsx(Un,{children:"My daily norma"}),s.jsx(Mt,{initialValues:{gender:"man",weight:"",activityHours:""},validationSchema:bt().shape({gender:pt().required("Gender is required"),weight:$e().required("Weight is required").positive().integer(),activityHours:$e().required("Activity hours is required").positive().integer()}),onSubmit:(t,{setSubmitting:r})=>{const i=e(t);n({waterIntake:i}),console.log("Form data:",{...t,waterIntake:i}),r(!1)},children:({isSubmitting:t,errors:r,touched:i,values:a,setFieldValue:o})=>s.jsxs(Ct,{children:[s.jsxs(Gn,{children:[s.jsxs(Re,{children:["For girl:"," ",s.jsx(Le,{children:"V=(M*0,03) + (T*0,4)"})]}),s.jsxs(Re,{children:["For man:"," ",s.jsx(Le,{children:"V=(M*0,04) + (T*0,6)"})]})]}),s.jsx(Qn,{children:s.jsxs(Zn,{children:[s.jsx(Jn,{children:"* "}),"V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})}),s.jsxs(Kn,{children:[s.jsx(er,{children:"Calculate your rate:"}),s.jsxs(tr,{children:[s.jsxs("label",{children:[s.jsx(te,{type:"radio",name:"gender",value:"man",onChange:()=>o("gender","man")}),"For man"]}),s.jsxs("label",{children:[s.jsx(te,{type:"radio",name:"gender",value:"woman",onChange:()=>o("gender","woman")}),"For woman"]})]}),r.gender&&i.gender&&s.jsx("div",{children:r.gender})]}),s.jsx(Ie,{children:s.jsxs(qe,{children:["Your weight in kilograms:",s.jsx(te,{type:"number",name:"weight",placeholder:"0",component:Ve}),r.weight&&i.weight&&s.jsx("div",{children:r.weight})]})}),s.jsx(Ie,{children:s.jsxs(qe,{children:["The time of active participation in sports or other activities with a high physical. load in hours:",s.jsx(te,{type:"number",name:"activityHours",placeholder:"0",component:Ve}),r.activityHours&&i.activityHours&&s.jsx("div",{children:r.activityHours})]})}),s.jsx(nr,{children:s.jsxs("p",{children:["Your recommended water intake per day is:",e(a)?parseFloat(e(a)).toFixed(2):0,"liters"]})}),s.jsx(rr,{type:"submit",disabled:t,children:"Save"})]})})]})}const ar=()=>{const[n,e]=S.useState(!1),t=()=>{e(!n)},i=(2e3/1e3).toFixed(1)+" L";return s.jsxs(Yt,{children:[s.jsxs(It,{children:[s.jsx(Lt,{children:"My daily norma"}),s.jsxs(qt,{children:[s.jsx("p",{children:i}),s.jsx(Vt,{type:"button",onClick:t,children:"Edit"})]})]}),s.jsx(Rt,{}),n&&s.jsx(je,{onClose:t,children:s.jsx(sr,{})})]})},or=h.div`
  display: flex;
  flex-direction: column;
  gap: 20px;
  justify-content: center;
...
`,yr=()=>s.jsx(br,{}),wr=n=>n.root.isLoading,kr=h.div`
  padding-left: 12px;
  padding-right: 12px;
  padding-bottom: 24px;
  display: flex;
...
`,Ge=({onClose:n})=>{const[t,r]=S.useState(0),[i,a]=S.useState(new Date().toISOString().slice(0,16)),o=it(),{isLoading:c}=se(wr),u=m=>{let x=m.target.value;x.startsWith("0")&&x.length>1&&(x=parseFloat(x.substring(1))),r(x.toString())},d=()=>{o(Et({waterVolume:t,date:i})).then(x=>{x.error||(n(),r(0))})},f=()=>{r(m=>Math.max(m-50,0))},p=()=>{const m=t+50,x=5e3;r(m<=x?m:x)};return s.jsx(s.Fragment,{children:s.jsxs(kr,{onClose:n,children:[s.jsxs(vr,{children:[s.jsx($r,{children:"Add Water"}),s.jsx(jr,{children:"Choose a value:"}),s.jsx(He,{children:"Amount of water:"}),s.jsxs("div",{children:[s.jsx(Xe,{onClick:f,children:s.jsx(Ue,{children:s.jsx("use",{href:`${b}#icon-minus`})})}),s.jsx(Sr,{children:s.jsxs(Or,{children:[t," ml"]})}),s.jsx(Xe,{onClick:p,children:s.jsx(Ue,{children:s.jsx("use",{href:`${b}#icon-plus`})})})]})]}),s.jsxs(Fr,{children:[s.jsx(He,{children:"Recording time:"}),s.jsx(_r,{value:i,onChange:m=>a(m.target.value),step:"300"})]}),s.jsxs("div",{children:[s.jsx("h3",{children:"Enter the value of the water used:"}),s.jsx(Tr,{type:"number",value:t,onChange:u,onBlur:()=>r(m=>m||0||0),max:5e3})]}),s.jsxs(Dr,{children:[s.jsxs("span",{children:[t,"ml"]}),s.jsxs(Er,{onClick:d,children:["Save ",c&&s.jsx(yr,{})]})]})]})})},Mr=()=>{const[n,e]=S.useState(!1),t=()=>{e(!n)},r=88;return s.jsxs(or,{children:[s.jsxs(cr,{children:[s.jsx(lr,{children:"Today"}),s.jsxs(ur,{children:[s.jsx(dr,{children:s.jsx(hr,{style:{width:`${Math.min(r,100)}%`}})}),s.jsxs(fr,{children:[s.jsx(pr,{children:"0%"}),s.jsxs(xr,{left:`${r}%`,children:[r,"%"]}),s.jsx(mr,{children:"100%"})]})]})]}),s.jsxs(gr,{onClick:t,children:[s.jsx("svg",{children:s.jsx("use",{href:`${b}#icon-outline`})}),"Add water"]}),s.jsx(Ge,{}),n&&s.jsx(je,{onClose:t,children:s.jsx(Ge,{})})]})},Cr=h.div`
  display: flex;
  flex-direction: column;
  margin-bottom: 24px;
`,Pr=h.div`
...
`,rs=()=>s.jsx(s.Fragment,{children:s.jsx(Ki,{children:s.jsxs(Qi,{children:[s.jsxs(Ji,{children:[s.jsx(ar,{}),s.jsx(Mr,{})]}),s.jsxs(Zi,{children:[s.jsx(Nr,{}),s.jsx(Gi,{})]})]})})});export{rs as default};
