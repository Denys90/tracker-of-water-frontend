...
`,I=e=>e.waters.dailyNorm,se=e=>e.waters.reps,ce=e=>e.filter,Ce=e=>e.waters;me([I,ce],(e,n)=>e.filter(t=>t.name.toLowerCase().includes(n.toLowerCase())));const Fe=()=>{const e=R(),n=W(I),t=W(se),r=W(ce),i=w.useCallback(u=>e(ie(u)),[e]),c=w.useCallback(u=>e(pe(u)),[e]),d=w.useCallback(u=>e(xe(u)),[e]),h=w.useCallback(u=>e(fe(u)),[e]);return{dailyNorm:n,reps:t,filter:r,getWaters:i,addDailyNorma:c,deleteReps:d,patchWater:h}},_e=s.h2`
  font-size: 26px;
  line-height: 32px;
  margin-bottom: 24px;
`,Ye=s.div`
...
`,Dn=s.div`
  ...
  font-size: 14px;
  margin-top: 4px;
`,Pn=({onClose:e,initialTime:n})=>{const[r,i]=w.useState(0),[c,d]=w.useState("");w.useEffect(()=>{let f;if(n){const l=new Date(n),y=Math.round(l.getMinutes()/5)*5;l.setMinutes(y),f=q(l,"HH:mm")}else{const l=new Date,y=Math.round(l.getMinutes()/5)*5;l.setMinutes(y),f=q(l,"HH:mm")}d(f)},[n]);const h=R(),{isLoading:u}=W(pn),[x,b]=w.useState(""),k=f=>{let l=f.target.value;if(l>5e3){b("The value cannot exceed 5000ml");return}else b("");l.startsWith("0")&&l.length>1&&(l=parseFloat(l.substring(1))),i(l.toString())},j=()=>{h(we({waterVolume:r,date:c})).then(l=>{l.error||(e(),i(0))})},$=()=>{i(f=>Math.max(f-50,0))},O=()=>{const f=r+50,l=5e3;i(f<=l?f:l)};return o.jsx(o.Fragment,{children:o.jsxs(xn,{onClose:e,children:[o.jsxs(fn,{children:[o.jsx(gn,{children:"Add Water"}),o.jsx(bn,{children:"Choose a value:"}),o.jsx(ne,{children:"Amount of water:"}),o.jsxs("div",{children:[o.jsx(re,{onClick:$,children:o.jsx(oe,{children:o.jsx("use",{href:`${M}#icon-minus`})})}),o.jsx(yn,{children:o.jsxs(wn,{children:[r," ml"]})}),o.jsx(re,{onClick:O,children:o.jsx(oe,{children:o.jsx("use",{href:`${M}#icon-plus`})})})]})]}),o.jsxs(kn,{children:[o.jsx(ne,{children:"Recording time:"}),o.jsx(vn,{type:"time",value:c,onChange:f=>d(f.target.value),step:300})]}),o.jsxs("div",{children:[o.jsx("h3",{children:"Enter the value of the water used:"}),o.jsx(jn,{type:"number",value:r,onChange:k,onBlur:()=>i(f=>f||0||0),max:5e3}),x&&o.jsx(Dn,{children:x})]}),o.jsxs($n,{children:[o.jsxs("span",{children:[r,"ml"]}),o.jsxs(Mn,{onClick:j,children:["Save ",u&&o.jsx(st,{})]})]})]})})},Wn=()=>{const[e,n]=w.useState(!1),t=W(Ce),r=()=>{n(!e)},i=t.percent;return o.jsxs(Ve,{children:[o.jsxs(Ue,{children:[o.jsx(Je,{children:"Today"}),o.jsxs(Ke,{children:[o.jsx(Ze,{children:o.jsx(et,{style:{width:`${Math.min(i,100)}%`}})}),o.jsxs(tt,{children:[o.jsx(nt,{children:"0%"}),i<100&&i>0&&o.jsxs(ot,{left:`${i}%`,children:[i,"%"]}),o.jsx(rt,{children:"100%"})]})]})]}),o.jsxs(at,{onClick:r,children:[o.jsx("svg",{children:o.jsx("use",{href:`${M}#icon-outline`})}),"Add water"]}),e&&o.jsx(X,{onClose:r,children:o.jsx(Pn,{})})]})},Sn=s.div`
  display: flex;
  flex-direction: column;
  margin-bottom: 24px;
`,On=s.div`
