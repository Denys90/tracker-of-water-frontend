import{n as s,t as a,e as _e,f as ge,g as _,r as k,h as ze,i as Ee,k as Ne,p as He,l as Ae,F as R,j as r,b as re,c as Le,M as oe,s as S,E as fe,m as Re}from"./index-e42e3eff.js";import{h as qe,i as Ie,a as Xe,b as Qe,c as Ve,d as Ge,e as Je}from"./bottle_home_deskx2-ec9b98d1.js";const Ue="/runners_of_code__frontend/assets/bottle_home_mobile@1x-0d6054eb.png",Ke="/runners_of_code__frontend/assets/bottle_home_mobile@2x-52eb5066.png",Ze="/runners_of_code__frontend/assets/bottle_home_tablet@1x-c4bedac4.png",et="/runners_of_code__frontend/assets/bottle_home_tablet@2x-867eb443.png",tt="/runners_of_code__frontend/assets/bottle_home_desk-f67b46be.png",nt=s.div`
  display: flex;
...
`,ae=e=>e.waters.dailyNorm,ct=e=>e.waters.reps,be=e=>e.filter,dt=e=>e.waters.month,lt=e=>e.waters;_e([ae,be],(e,n)=>e.filter(t=>t.name.toLowerCase().includes(n.toLowerCase())));const A=()=>{const e=ge(),n=_(ae),t=_(ct),o=_(be),i=k.useCallback(d=>e(ze(d)),[e]),c=k.useCallback(d=>e(Ee(d)),[e]),l=k.useCallback(d=>e(Ne(d)),[e]),p=k.useCallback(d=>e(He(d)),[e]),u=k.useCallback(d=>e(Ae(d)),[e]);return{dailyNorm:n,reps:t,filter:o,addDailyNorma:c,deleteReps:l,patchWater:p,addOneDrink:u,createWater:i}},ut=s.h2`
  font-size: 26px;
  line-height: 32px;
  margin-bottom: 16px;
`,ht=s.div`
...
`,nn=({id:e,date:n,onClose:t})=>{const{deleteReps:o,createWater:i}=A(),c=()=>{o({id:e,date:n}),i(n),t()};return r.jsx(r.Fragment,{children:r.jsxs(Ut,{children:[r.jsxs(Kt,{children:[r.jsx("h2",{children:"Delete entry"}),r.jsx("p",{children:"Are you sure you want to delete the entry?"})]}),r.jsxs(Zt,{children:[r.jsx(en,{type:"button",onClick:t,children:"Cancel"}),r.jsx(tn,{type:"button",onClick:c,children:"Delete"})]})]})})},rn=()=>{const[e,n]=k.useState(!1),[t,o]=k.useState(null),{createWater:i,reps:c}=A(),l=Date.now(),u=new Date(l).toLocaleDateString();k.useEffect(()=>{i({date:u})},[u,i]);const d=(g,y)=>{o(g),n(!y),n(!0)},m=()=>{n(!1)};return r.jsxs(r.Fragment,{children:[r.jsxs(Et,{children:[r.jsx(At,{children:"Today"}),r.jsx(Nt,{children:c.map(g=>{const[y,j]=g.time.split(":").map(Number),D=y>=12?y-12:y,h=y>=12?"PM":"AM",w=D===0?12:D;return r.jsxs(Ht,{children:[r.jsxs(Lt,{children:[r.jsx(Rt,{children:r.jsx("use",{href:`${S}#icon-glass`})}),r.jsxs("h4",{children:[g.amount," ml"]}),r.jsxs("p",{children:[w,":",j<10?"0"+j:j," ",h]})]}),r.jsxs(qt,{children:[r.jsx(It,{onClick:()=>d(r.jsx(Jt,{id:g._id,onClose:m})),children:r.jsx("use",{href:`${S}#icon-note`})}),r.jsx(Xt,{onClick:()=>d(r.jsx(nn,{id:g._id,date:{date:u},onClose:m})),children:r.jsx("use",{href:`${S}#icon-trash`})})]})]},zt())})}),r.jsxs(Qt,{onClick:()=>d(r.jsx(We,{onClose:m})),children:[r.jsx("svg",{children:r.jsx("use",{href:`${S}#icon-increment`})}),"Add water"]})]}),e&&r.jsx(oe,{onClose:e,children:t})]})};const on=s.div`
  display: flex;
  flex-direction: column;
