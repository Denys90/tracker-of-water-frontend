...
`,tn=({id:e,date:n,toggleModal:t})=>{const{deleteReps:o,createWater:i}=_(),c=()=>{o({id:e,date:n}),i(n)};return r.jsx(r.Fragment,{children:r.jsxs(Jt,{children:[r.jsxs(Ut,{children:[r.jsx("h2",{children:"Delete entry"}),r.jsx("p",{children:"Are you sure you want to delete the entry?"})]}),r.jsxs(Kt,{children:[r.jsx(Zt,{type:"button",onClick:t,children:"Cancel"}),r.jsx(en,{type:"button",onClick:c,children:"Delete"})]})]})})},nn=()=>{const[e,n]=y.useState(!1),[t,o]=y.useState(null),{createWater:i}=_(),c=Date.now(),l=new Date(c).toLocaleDateString(),{reps:m}=_();y.useEffect(()=>{i({date:l})},[l,i]);const d=()=>{n(!e)},g=f=>{o(f),n(!0)};return r.jsxs(r.Fragment,{children:[r.jsxs(zt,{children:[r.jsx(Ht,{children:"Today"}),r.jsx(Et,{children:m.map(f=>{const[k,$]=f.time.split(":").map(Number),D=k>=12?k-12:k,h=k>=12?"PM":"AM",w=D===0?12:D;return r.jsxs(Nt,{children:[r.jsxs(At,{children:[r.jsx(Lt,{children:r.jsx("use",{href:`${M}#icon-glass`})}),r.jsxs("h4",{children:[f.amount," ml"]}),r.jsxs("p",{children:[w,":",$<10?"0"+$:$," ",h]})]}),r.jsxs(Rt,{children:[r.jsx(qt,{onClick:()=>g(r.jsx(Gt,{toggleModal:d})),children:r.jsx("use",{href:`${M}#icon-note`})}),r.jsx(It,{onClick:()=>g(r.jsx(tn,{toggleModal:d,id:f._id,date:{date:l}})),children:r.jsx("use",{href:`${M}#icon-trash`})})]})]},Yt())})}),r.jsxs(Xt,{onClick:()=>g(r.jsx(We,{})),children:[r.jsx("svg",{children:r.jsx("use",{href:`${M}#icon-increment`})}),"Add water"]})]}),e&&r.jsx(oe,{onClose:d,children:t})]})};const rn=s.div`
  display: flex;
  flex-direction: column;
